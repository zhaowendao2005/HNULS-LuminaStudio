...
export interface NormalChatWorkspaceDatasourceLike {
  ...
  deleteAssistant(payload: { assistantId: string }): Promise<NormalChatWorkspaceSnapshot>
...
const realDatasource: NormalChatWorkspaceDatasourceLike = {
  ...
  deleteAssistant(payload) {
    return window.api.normalChat.deleteAssistant(payload).then(unwrap)
  },
  createTopic(payload) {
...
export const NormalChatWorkspaceDatasource: NormalChatWorkspaceDatasourceLike = {
  ...
  deleteAssistant(payload) {
    return datasource.deleteAssistant(payload)
  },
  createTopic(payload) {
