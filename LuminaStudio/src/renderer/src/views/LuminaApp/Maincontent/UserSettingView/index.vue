...
const currentView = ref<'main' | 'model-config' | 'api-keys'>('main')
...
const handleOpenApiKeys = (): void => {
  currentView.value = 'api-keys'
  emit('enter-detail', '秘钥管理')
}
...
const handleBack = (): void => {
  if (currentView.value === 'model-config' || currentView.value === 'api-keys') {
    handleBackToMain()
  }
}
