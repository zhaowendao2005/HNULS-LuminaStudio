    ...
    <div class="relative z-10">
      ...
      <div class="flex justify-between items-end">
        ...
        <div class="flex gap-3">
          <button
            class="px-4 py-2 bg-white/60 backdrop-blur border border-slate-200 text-slate-600 rounded-lg text-sm font-medium hover:bg-white hover:border-emerald-200 transition-all shadow-sm"
          >
            Import FASTA/PDF
          </button>
          <button
            class="px-4 py-2 bg-gradient-to-r from-slate-900 to-slate-800 text-white rounded-lg text-sm font-medium hover:shadow-lg hover:shadow-slate-900/20 transition-all flex items-center gap-2 flex-shrink-0"
          >
            <svg
      ...
      <!-- Recent Papers -->
      <div
        class="bg-white/80 backdrop-blur-md rounded-2xl border border-emerald-100/50 shadow-sm overflow-hidden mt-8"
      >
        <div
          class="p-6 border-b border-emerald-50 flex justify-between items-center bg-emerald-50/30"
        >
          <h3 class="font-bold text-lg text-slate-800 flex items-center gap-2 flex-shrink-0">
            <svg
              class="w-[18px] h-[18px] flex-shrink-0 text-emerald-600"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              stroke-width="2"
...
const recentPapers = ref([
  ...
  {
    id: 3,
    title: 'mRNA Vaccine Technology Overview',
    authors: 'Karikó et al.',
